...
public class QuanLyHoaDonPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(jSeparator2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 140, 790, 20));
    ...
    void fillTableHoaDon(){
        ...
        for (HoaDon hoaDon : list) {
            ...
            DateHelper.toString(hoaDon.getNgayThanhToan(), "yyyy-MM-dd hh:mm:ss"),hoaDon.getMaKhachHang(),hoaDon.getMaNhanVien()};
            dtm.addRow(data);
        }
    }
    ...
    HoaDon getFormForHoaDon(){
        ...
        hd.setMaKhachHang(txtMaHoaDon.getText());
    ...
    void thanhToan(){
        ChiTietHoaDon ct = getFormForHoaDonChiTiet();
        if (ct == null) {
            return ;
        }
        try {
