...
public class ChiTietHoaDonDAO implements HairSalonDAO<ChiTietHoaDon, Integer>{
    String insert = "insert into hoadonchitiet(giamgia,tongtien,thanhtien,mahoadon,masanpham,madichvu) values(?,?,?,?,?,?)";
    String update = "update hoadonchitiet set giamgia=? ,tongtien=?,thanhtien=?,mahoadon=?,masanpham=?,madichvu=? where machitiethoadon=?";
